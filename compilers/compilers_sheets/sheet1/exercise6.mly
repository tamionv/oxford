...
%token                  BEGIN DO ELSE ELSEIF END IF THEN WHILE PRINT NEWLINE
...
stmt:  
  ...
  | IF expr THEN stmts elseif_list      { IfStmt ($2, $4, $5) }
  | WHILE expr DO stmts END             { WhileStmt ($2, $4) } ;

elseif_list:
    ELSEIF expr THEN stmts elseif_list { IfStmt ($2, $4, $5) }
    | ELSE stmts END { stmts }
    | END { Skip }
